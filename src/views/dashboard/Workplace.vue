  ...
  <page-header-wrapper>
    ...
    <template v-slot:extraContent>
      <div class="extra-content">
        <div class="stat-item">
          <a-statistic title="设备总数" :value="4" />
        </div>
        <div class="stat-item">
          <a-statistic title="在线设备" :value="2" suffix="/ 4" />
        </div>
        <div class="stat-item">
          <a-statistic title="项目访问" :value="350" />
        </div>
      </div>
    </template>
    ...
    <div>
      <a-row :gutter="24">
        ...
        <a-col style="padding: 0 12px" :xl="8" :lg="24" :md="24" :sm="24" :xs="24">
          ...
          <a-card title="指数" style="margin-bottom: 24px" :loading="radarLoading" :bordered="false"
            :body-style="{ padding: 0 }">
