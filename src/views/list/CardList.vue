<template>
  <page-header-wrapper :tab-list="tabList" :tab-active-key="tabActiveKey" :tab-change="(key) => {
      this.tabActiveKey = key
    }" content="段落示意：老李工作室务设计平台 ant.design，用最小的工作量，无缝接入老李工作室生态， 提供跨越设计与开发的体验解决方案。">
